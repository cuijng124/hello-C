$(function () {
    ...
    $(document).scroll(function () {
        ...
        if(p/1.5<=triangle4){
            ...
            $(".triangles li:nth-child(4)").css({top:p/1.5});
        }
        if(p/5<=triangle5){
            $(".triangles li:nth-child(5)").css({top:triangle5});
        }else{
            $(".triangles li:nth-child(5)").css({top:p/5});
        }
        if(p<=triangle6){
            $(".triangles li:nth-child(6)").css({top:triangle6-p/1.5});
        }else{
            $(".triangles li:nth-child(6)").css({top:triangle6-p/1.5});
        }
        if(p/2<=triangle7){
            ...
            $(".triangles li:nth-child(7)").css({top:p});
        }
        if(p/1.5<=triangle8){
        ...
        if(p/1.2<=triangle9){
            $(".triangles li:nth-child(9)").css({top:triangle9-p});
        }else{
            $(".triangles li:nth-child(9)").css({top:p});
        }
    })
});